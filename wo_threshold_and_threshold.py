...
def main(argv) -> None:
  ...
  peg_folder = './object_images/edge/3d_printed_3/peg'
  hole_folder = './object_images/edge/3d_printed_3/hole'
  ...
  for i, peg_image in enumerate(peg_images):
    ...
    for j, hole_image in enumerate(hole_images):
      ...
      plt.axis("off")
      save_dir_wo_threshold = f"./result_images/edge/3d_printed_3/{object_label_peg}_peg/{object_label_hole}_wo_threshold.png"
      save_image(save_dir_wo_threshold, viz)
      plt.close()
      ...
      plt.figure(figsize=(20, 10), dpi=100, facecolor="w", edgecolor="k")
      plt.axis("off")
      save_dir_threshold = f"./result_images/edge/3d_printed_3/{object_label_peg}_peg/{object_label_hole}_threshold.png"
